...
CallbackBillingPlugin.prototype.requestPurchase = function(success, fail, productId, developerPayload) {
	PhoneGap.exec(success, fail, "CallbackBillingPlugin", "requestPurchase", [productId, developerPayload]);
};
